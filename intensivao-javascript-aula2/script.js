...
function trocarTamanho () {
    ...
    tamanahoSelecionado = idOpcaoSelecionada.charAt(0);
    //mudar o título do produto
    tituloProduto.innerText = " pulseira loop esportiva " + opcoesCores[corSelecionada].nome + " para caixa de " + opcoesTamanho[tamanahoSelecionado];
    //mudar o tamanaho da imagem de acordo com a opcao
    if (opcoesTamanho[tamanahoSelecionado] === '41 mm') {
